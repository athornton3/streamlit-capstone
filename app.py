...
try:
    ...
    with c2: # Map demo
        ...
        m.add_circle_markers_from_xy(map_data, x="longitude", y="latitude", radius=5, tooltip="click for info", popup='Institution-Name'+'Investigator-PI_FULL_NAME') #min-width and max-width for the popup
