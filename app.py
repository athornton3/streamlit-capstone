...
try:
    ...
    with c2: # Map demo
        ...
        m = leafmap.Map(center=(39.381266, -97.922211), zoom=4)label= '{}, {}'.format(bar, pos)
        m.add_circle_markers_from_xy(map_data, x="longitude", y="latitude", radius=5, tooltip="latitude", popup='{} {}'.format('Institution-Name','Investigator-PI_FULL_NAME')) #min-width and max-width for the popup
