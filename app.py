...
def search_projects(title, abstract, n):
    ...
    for prj in results[0]:
        ...
        scores.append(pd.DataFrame({"Index0" : prj['corpus_id'], "cosim" : prj['score']}, ignore_index=True))
...
try:
    ...
    with c2: # Map demo
        ...
        m.add_circle_markers_from_xy(map_data, x="longitude", y="latitude", radius=5, popup='Institution') #min-width and max-width for the popup
